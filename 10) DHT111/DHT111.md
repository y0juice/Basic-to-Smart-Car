...
__
### (1) 이론 설명 ###
<img width="417" height="188" alt="image" src="https://github.com/user-attachments/assets/7c86b162-3e4c-4cb7-9cd2-ab1c6333c8a5" />
...
=>(3) DHT11_ReadBit(): 센서가 High 유지하는 시간으로 0/1유지
=>
```c
  /* USER CODE BEGIN 2 */
  // 타이머 시작 (마이크로초 단위 지연용)
