...
- RCC(Reset & Clcok Contorl
Nucleo -F103RB에서 사용가능한 클록소스는 크게 내부클럭, 외부클럭이 있다.

(외부클럭: ST-Link의 8MHz 크리스탈 출력을 bypass 해서 사용. X3 위치에 8MHz 크리스털을 납땜하여 그 출력을 클럭으로 사용하는 방법)
...
<img width="2412" height="894" alt="image" src="https://github.com/user-attachments/assets/556c5bb1-9724-4064-a123-23d332a8e74d" />
